...
export const SHARE_ACCESSES_TABLE = 'SHARE_ACCESSES_TABLE';
...
export const MARKETPLACE_REPORTS_TABLE = 'MARKETPLACE_REPORTS_TABLE';
export const SPACES_TABLE = 'SPACES_TABLE';
